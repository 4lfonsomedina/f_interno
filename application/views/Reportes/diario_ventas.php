...
<div class="col col-md-10">
	<div class="panel panel-default">
		<div class="panel-heading titulo_panel">Diario de ventas</i></div>
		<div class="panel-body">
			<div class="row bottom-padding-50 formulario_style">
			<form action="<?= site_url('reportes/ventas/diario_ventas_global');?>" method="POST" class="form-consulta">
				...
				<div class="col col-md-3">
					...
					<select class="form-control" name="ano">
						<?php for($e=0;$e<5;$e++){?>
						<option value="<?= date('Y')-$e ?>" <?php if($ano==(date('Y')-$e)) echo "selected"; ?> >
							<?= date('Y')-$e ?>
						</option>
						<?php } ?>
					</select>
				...
				<br>
				<div class="col col-md-6"><button class="btn btn-success">GENERAR</button></div>
			</form>
			</div>
			<?php if(isset($ventas)){
