	...
	<div class="panel panel-default">
		...
		<div class="panel-body">
			...
			<div class="row bottom-padding-50 formulario_style">
				<form method="POST" action="<?= site_url('Reportes/Ventas') ?>" class="form-consulta">
				<div class="col-md-4"><b>SUCURSAL</b>
					<select class="form-control" name="sucursal">
						...
						<option value="localmexquite" <?php if($sucursal=='localmexquite') echo "selected"; ?>>MEXQUITE</option>
					</select>
				</div>
				<div class="col-md-2">
					<b>AGRUPADO</b>
